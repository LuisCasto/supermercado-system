        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            <div>
              ...
              <p className="text-3xl font-bold text-gray-800 mt-2">{stats.total_sales}</p>
            </div>
          </Card>
          <Card>
            <div>
              <p className="text-sm text-gray-600">Monto Total</p>
              <p className="text-3xl font-bold text-green-600 mt-2">${stats.total_amount?.toFixed(2)}</p>
            </div>
          </Card>
          <Card>
            <div>
              <p className="text-sm text-gray-600">Ticket Promedio</p>
              <p className="text-3xl font-bold text-blue-600 mt-2">${stats.average_ticket?.toFixed(2)}</p>
            </div>
          </Card>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card>
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800 mt-2">{metrics.products?.total}</p>
              <p className="text-xs text-green-600 mt-1">{metrics.products?.active} activos</p>
            </div>
          </Card>
          <Card>
            <div>
              <p className="text-sm text-gray-600">Lotes de Inventario</p>
              <p className="text-2xl font-bold text-gray-800 mt-2">{metrics.inventory?.total_batches}</p>
            </div>
          </Card>
          <Card>
            <div>
              <p className="text-sm text-gray-600">Usuarios</p>
              <p className="text-2xl font-bold text-gray-800 mt-2">{metrics.users?.total}</p>
              <p className="text-xs text-green-600 mt-1">{metrics.users?.active} activos</p>
            </div>
          </Card>
          <Card>
            <div>
              <p className="text-sm text-gray-600">Tickets Vendidos</p>
              <p className="text-2xl font-bold text-gray-800 mt-2">{metrics.sales?.total_tickets}</p>
            </div>
          </Card>
        </div>
      )}
        ...
        <Card title="Estado del Outbox">
          <div className="grid grid-cols-4 gap-4">
            <div className="text-center p-4 bg-yellow-50 rounded-lg">
              <p className="text-2xl font-bold text-yellow-600">{outboxStats.pending}</p>
              <p className="text-sm text-gray-600 mt-1">Pendientes</p>
            </div>
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              <p className="text-2xl font-bold text-blue-600">{outboxStats.processing}</p>
              <p className="text-sm text-gray-600 mt-1">Procesando</p>
            </div>
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <p className="text-2xl font-bold text-green-600">{outboxStats.completed}</p>
              <p className="text-sm text-gray-600 mt-1">Completados</p>
            </div>
            <div className="text-center p-4 bg-red-50 rounded-lg">
              <p className="text-2xl font-bold text-red-600">{outboxStats.failed}</p>
              <p className="text-sm text-gray-600 mt-1">Fallidos</p>
            </div>
          </div>

          {outboxStats.recent_failures?.length > 0 && (
            <div className="mt-4">
